...
st.set_page_config(page_title="Airbnb Data Visualization | By Nivash ",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Nivash*!
...
client = pymongo.MongoClient(mongodb+srv://knivash1510:Knivash@nivash.jswxcvq.mongodb.net/)
